...
const PROJECTS: Project[] = [
  {
    ...
    challenge:
      "Enterprises struggled to orchestrate complex AI workflows without fragile custom infrastructure.",
    solution:
      "Visual drag-and-drop engine connecting LLMs to enterprise data. Rust execution backend handles concurrency without GC pauses.",
    features: [
    ...
    metric: "1k+ requests/day processed",
  ...
  },
  {
    ...
    challenge:
      "Institutional crypto custody on Solana required insecure workarounds or complex multisig with no policy controls.",
    solution:
      "PDA-based vault architecture with on-chain policy enforcement — spend limits, time locks, multi-approval flows.",
    features: [
      "Policy-based spend limits",
  ...
  },
  {
    ...
    challenge:
      "Existing code assistants were too slow for real-time pairing and lacked full monorepo context.",
    solution:
      "Custom AST parser builds a live dependency graph. Tree-sitter parses without a language server. Redis caches embeddings.",
    features: [
      "< 400ms response time",
...
function ProjectCard({
  ...
  return (
    <motion.div
      ...
      whileHover={{
        boxShadow: `0 0 40px ${project.color}22, 0 0 0 1px ${project.color}33`,
      }}
    >
      {/* Top accent bar */}
      <div
      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-1.5">
          {project.tech.slice(0, 4).map((t) => (
            <span
              key={t}
              className="text-[10px] font-mono text-white/30 px-2 py-0.5 rounded bg-white/5"
            >
              {t}
            </span>
          ))}
        ...
        <div className="p-6 md:p-10">
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-8">
            {[
              ...
              { label: "Outcome", val: project.metric },
            ].map(({ label, val }) => (
              <div
                key={label}
  ...
  return (
    <section id="projects" className="relative py-32 overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div
          className="absolute top-0 left-1/3 w-[600px] h-[400px] rounded-full blur-[120px] opacity-[0.04]"
          style={{
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        >
          ...
          <p className="text-white/50 mt-4 max-w-xl mx-auto">
            Each project started as a problem worth solving. Click to open the
            full case study.
          </p>
        </motion.div>
