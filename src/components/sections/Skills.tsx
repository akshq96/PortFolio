...
const SKILLS: Skill[] = [
  // Frontend
  {
    ...
    projects: 12,
    confidence: 92,
    desc: "Primary framework for all UI work. Deep knowledge of hooks, context, and perf patterns.",
    color: "#06b6d4",
    x: 18,
    y: 20,
    size: 1.2,
  },
  {
    ...
    projects: 7,
    confidence: 87,
    desc: "App Router, SSR, ISR, edge functions. Ships most of my production web work.",
    color: "#3b82f6",
    x: 30,
    y: 12,
    size: 1.1,
  },
  {
    ...
    projects: 14,
    confidence: 93,
    desc: "Types everywhere. I refuse to ship untyped code to production.",
    color: "#60a5fa",
    x: 14,
    y: 38,
    size: 1.15,
  },
  {
    ...
    projects: 5,
    confidence: 90,
    desc: "Utility-first CSS. Faster than any other styling approach I've used.",
    color: "#38bdf8",
    x: 26,
    y: 32,
    size: 1.0,
  ...
  // Backend
  {
    ...
    projects: 9,
    confidence: 86,
    desc: "Event-loop internals, streams, clustering. My go-to for APIs.",
    color: "#4ade80",
    x: 50,
    y: 18,
    size: 1.15,
  },
  {
    ...
    projects: 3,
    confidence: 70,
    desc: "Ownership model clicked fast. Used for performance-critical engines and Solana programs.",
    color: "#fb923c",
    x: 44,
    y: 34,
    size: 1.0,
  },
  {
    ...
    projects: 8,
    confidence: 85,
    desc: "Minimal, flexible. Built dozens of REST and middleware layers with it.",
    color: "#86efac",
    x: 56,
    y: 30,
    size: 0.95,
  ...
  // Database
  {
    ...
    projects: 6,
    confidence: 80,
    desc: "ACID compliance, complex joins, Drizzle ORM. Production-grade data.",
    color: "#818cf8",
    x: 38,
    y: 52,
    size: 1.0,
  },
  {
    ...
    projects: 5,
    confidence: 75,
    desc: "Flexible schema for rapid prototyping. Aggregation pipelines for analytics.",
    color: "#4ade80",
    x: 26,
    y: 60,
    size: 0.9,
  ...
  // Blockchain
  {
    ...
    projects: 4,
    confidence: 72,
    desc: "Anchor framework, PDA architecture, SPL tokens. Built ChainVault on it.",
    color: "#a78bfa",
    x: 70,
    y: 22,
    size: 1.1,
  },
  {
    ...
    projects: 4,
    confidence: 70,
    desc: "EVM, storage layout, reentrancy guards. Audited my own contracts.",
    color: "#c084fc",
    x: 80,
    y: 14,
    size: 1.0,
  },
  {
    ...
    projects: 3,
    confidence: 68,
    desc: "L2 bridges, ERC standards, Foundry testing. DeFi protocol mechanics.",
    color: "#818cf8",
    x: 74,
    y: 38,
    size: 0.95,
  ...
  },
  {
    ...
    projects: 5,
    confidence: 80,
    desc: "ReAct loops, tool use, memory systems. NeuroFlow is the culmination.",
    color: "#6ee7b7",
    x: 74,
    y: 60,
    size: 1.05,
  },
  {
    ...
    projects: 3,
    confidence: 75,
    desc: "Chains, RAG pipelines, vector stores. Used when the plumbing matters more than the model.",
    color: "#10b981",
    x: 84,
    y: 50,
    size: 0.9,
  ...
  // Tools
  {
    ...
    projects: 7,
    confidence: 78,
    desc: "Multi-stage builds, compose stacks, container networking.",
    color: "#7dd3fc",
    x: 88,
    y: 28,
    size: 0.9,
  ...
  return (
    <section id="skills" className="relative py-32 overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div
          className="absolute bottom-0 right-0 w-[500px] h-[500px] rounded-full blur-[120px] opacity-5"
          style={{
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        >
          ...
          <p className="text-white/50 mt-4 max-w-xl mx-auto">
            Hover any node to explore — years, projects, and what I actually
            know.
          </p>
        </motion.div>
