...
const SOCIALS = [
  ...
  },
  {
    icon: Twitter,
    label: "Twitter",
    href: "https://x.com/Akshq96",
    value: "@Akshq96",
  },
  {
    icon: Mail,
    label: "Email",
    href: "mailto:akshitraj19@gmail.com",
    value: "akshitraj19@gmail.com",
  },
];
    ...
    <section id="contact" className="relative py-32 overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div
          ...
          style={{
            background:
              "linear-gradient(to top, rgba(59,130,246,0.04), transparent)",
          }}
        />
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="glass-card rounded-2xl p-8">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-8">
                <div className="relative">
                  <label
                    className={`absolute -top-5 left-0 text-[10px] font-mono uppercase tracking-widest transition-colors duration-300 ${
                      focused === "name" ? "text-primary" : "text-white/30"
                    }`}
                  >
                    Name
                  </label>
                ...
                <div className="relative">
                  <label
                    className={`absolute -top-5 left-0 text-[10px] font-mono uppercase tracking-widest transition-colors duration-300 ${
                      focused === "message" ? "text-primary" : "text-white/30"
                    }`}
                  >
                    Message
                  </label>
          ...
          >
            <div>
              <h3 className="text-xs font-mono uppercase tracking-widest text-white/30 mb-5">
                Direct Lines
              </h3>
                ...
                {SOCIALS.map(({ icon: Icon, label, href, value }) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-sm text-white/70 group-hover:text-white font-mono transition-colors duration-300 truncate">
                        {value}
                      </div>
                    </div>
                    <span className="text-white/20 group-hover:text-primary transition-colors duration-300 text-lg leading-none">
                      ↗
                    </span>
                  </a>
                ))}
            ...
            <div className="glass-card rounded-xl p-6">
              ...
              <p className="text-sm text-white/50 mb-4">
                Full work history, projects, and references. PDF format.
              </p>
              <a
                href="/resume.pdf"
