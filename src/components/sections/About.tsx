...
function TimelineItem({
  ...
  return (
    <div ref={ref} className="relative flex items-center gap-0 w-full">
      ...
      <div
        className={`flex-1 ${
          isLeft ? "flex justify-end pr-8 md:pr-12" : "pr-8 md:pr-12 invisible"
        }`}
      >
        {isLeft && (
          <motion.div
      ...
      <div
        className={`flex-1 ${
          !isLeft
            ? "flex justify-start pl-8 md:pl-12"
            : "pl-8 md:pl-12 invisible"
        }`}
      >
        {!isLeft && (
          <motion.div
  ...
  return (
    <section id="about" className="relative py-32 overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full blur-[120px] opacity-5"
          style={{
